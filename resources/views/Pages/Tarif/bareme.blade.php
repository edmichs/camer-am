            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <a href="{{route('add_bareme_path')}}" class="btn btn-info"><i class="fa fa-plus"></i>Nouveau Bareme</a>
                        @if(session('message'))
                            <div class="row">
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable">
                            ...
                            @foreach($baremes as $bareme)
                                <tr>
                                    ...
                                    <td>{{ $bareme->Taux_rembrousement}}</td>
                                    <td >

                                        <a href="{{url("tarif/bareme/edit/{$bareme->ID}")}}" class="btn btn-warning"
                                           title="Modifier">
                                            <i class="fa fa-edit " style="margin-right: 0.5%;" >

                                            </i>
                                        </a>
                                        <a href="{{url("tarif/bareme/delete/{$bareme->ID}")}}" class="btn btn-danger"
                                           title="Supprimer">
                                            <i class=" fa fa-trash " >
