            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <a href="{{route('add_prestation_path')}}" class="btn btn-info"><i class="fa fa-plus"></i>Nouvelle Prestation</a>
                        @if(session('message'))
                            <div class="row">
                            ...
                            @foreach($prestations as $prestation)
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <a href="{{url("tarif/prestation/edit/{$prestation->ID}")}}" class="btn btn-warning"
                                           title="Modifier">
                                            <i class="fa fa-edit " style="margin-right: 0.5%;" >

                                            </i>
                                        </a>
                                        <a href="{{url("tarif/prestation/delete/{$prestation->ID}")}}" class="btn btn-danger"
                                           title="Supprimer">
                                            <i class=" fa fa-trash " >
