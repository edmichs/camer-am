...
@section('js')
    ...
    <script type="text/javascript">
        ...
        /* $("#form").submit(function(e) {
         ...
         //alert(data);
         if (data == 0) {
         message('<h4> Veuillez ajouter une �quipe ! </h4>', 'alert-warning pull-lg-right');
         }else{
         message('<h4> Op�ration r�ussie ! </h4>', 'alert-success pull-lg-right');
         }
         ...
         message("<h4> Echec de l'op�ration ! </h4>", 'alert-danger pull-lg-right');
         }
         });
