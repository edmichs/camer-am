...
@section('content')
    <section class="content-header">
        <h1>
            Liste des Remboursements/Soci&eacute;t&eacute;s
            <!--small>Preview</small-->
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Liste des Remboursements</h3><br>
                        <a href="{{route('add_souscripteur_path')}}" class="btn btn-info"><i class="fa fa-plus"></i>Nouveau Remboursement</a>
                        @if(session('message'))
                            <div class="row">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                        <label for="souscripteur">Remboursement: <span>*</span></label>
