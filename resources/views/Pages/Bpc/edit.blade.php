                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="selectpicker form-control" onchange="val()" name="PoliceID"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="Date_echeance" id="Date_echeance"
                                                   class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="selectpicker form-control" name="AffectionID"
                                                    id="AffectionID"
                                                    data-show-subtext="true" data-live-search="true">
                                                @foreach($affections as $affection)
                                                    <option data-subtext="{{$affection->Code}}"
                                                            value="{{$affection->ID}}">{{$affection->Description}}</option>
                                                @endforeach
                                                <a href="{{route('add_bpc_path')}}" class="btn btn-info" type>Creer un
                                                    nouveau</a>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="Taux_couverture"
                                                   id="Taux_couverture">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="Date_sinistre"
                                                   id="Date_sinistre">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="selectpicker form-control" name="Centre_santeID"
                                                    id="Centre_santeID" data-show-subtext="true"
                                                    data-live-search="true">
                                                <option value=" ">-- selectionner un centre de sante --</option>
                                                @foreach($centresantes as $centresante)
                                                    <option data-subtext="{{$centresante->Email}}"
                                                            value="{{$centresante->ID}}">{{$centresante->Nom}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="selectpicker form-control" onchange="changeMedecin()"
                                                    name="MedecinConseilID" id="MedecinConseilID"
                                                    data-show-subtext="true"
                                                    data-live-search="true">
                                                <option value=" ">-- selectionner un centre de sante --</option>
                                                @foreach($medecins as $medecin)
                                                    <option data-subtext="{{$medecin->Email}}"
                                                            value="{{$medecin->ID}}">{{$medecin->Noms}}</option>
                                                @endforeach
                                            </select>
                                            T&egrave;l :
                                            <input type="tel" name="Tel_medecin" id="Tel_medecin" class="form-control">
                                            Email :
                                            <input type="email" name="email_medecin" id="email_medecin"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
