                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                            ...
                                            if (d === " ") {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        message('<h4> Membre ajouté avec succes ! </h4>', 'alert-success pull-lg-right');
                                                    },
                                                    error: function (jqXHR, textStatus, errorThrown) { // What to do if we fail
                                                        /*console.log(JSON.stringify(jqXHR));
                                                         console.log("AJAX error: " + textStatus + ' : ' + errorThrown);*/
                                    ...
                                    <div class=" col-md-12">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Montant d&eacute;clar&eacute;</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-info " type="submit" name="action">Enregistrer sans
                                            Imprimer
                                        </button>
                                        <button class="btn btn-primary " type="submit" name="action">Enregistrer et
                                            Imprimer
                                        </button>
                                    </div>
                                </div>
